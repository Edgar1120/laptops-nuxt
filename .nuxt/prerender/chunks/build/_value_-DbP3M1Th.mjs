...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: docs } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      `facet-cpu-` + value,
      () => queryContent("/laptops").where({ cpu: value }).find(),
      "$QedEWM_ll5"
    )), __temp = await __temp, __restore(), __temp);
    return (_ctx, _push, _parent, _attrs) => {
      const _component_LaptopCard = __nuxt_component_0;
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "facet-detail" }, _attrs))} data-v-408b0c1d><h1 data-v-408b0c1d>Procesador: ${ssrInterpolate(unref(value))}</h1><div class="grid" data-v-408b0c1d><!--[-->`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/cpu/[value].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const _value_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-408b0c1d"]]);

export { _value_ as default };
//# sourceMappingURL=_value_-DbP3M1Th.mjs.map
