...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: docs } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      `facet-brand-` + value,
      () => queryContent("/laptops").where({ brand: value }).find(),
      "$DxM8dB5yWZ"
    )), __temp = await __temp, __restore(), __temp);
    return (_ctx, _push, _parent, _attrs) => {
      const _component_LaptopCard = __nuxt_component_0;
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "facet-detail" }, _attrs))} data-v-c31b2081><h1 data-v-c31b2081>Marca: ${ssrInterpolate(unref(value))}</h1><div class="grid" data-v-c31b2081><!--[-->`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/brand/[value].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const _value_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c31b2081"]]);

export { _value_ as default };
//# sourceMappingURL=_value_-Z000C-rT.mjs.map
