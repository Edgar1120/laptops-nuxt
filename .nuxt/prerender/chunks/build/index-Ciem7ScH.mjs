...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: items } = ([__temp, __restore] = withAsyncContext(async () => useAsyncData(`facet-${"brand"}`, async () => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "facet-list" }, _attrs))} data-v-03fceff1><h1 data-v-03fceff1>${ssrInterpolate(_ctx.title)}</h1><ul data-v-03fceff1><!--[-->`);
      ssrRenderList(unref(items), (val) => {
        _push(`<li data-v-03fceff1>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: `/brand/${encodeURIComponent(String(val))}`
        }, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/brand/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-03fceff1"]]);

export { index as default };
//# sourceMappingURL=index-Ciem7ScH.mjs.map
