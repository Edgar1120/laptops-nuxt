...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: items } = ([__temp, __restore] = withAsyncContext(async () => useAsyncData(`facet-${"screenInches"}`, async () => {
      const all = await queryContent("/laptops").only(["screenInches"]).find();
      const vals = Array.from(new Set(all.map((i) => i["screenInches"]).filter(Boolean)));
      vals.sort((a, b) => String(a).localeCompare(String(b), "es"));
      return vals;
    })), __temp = await __temp, __restore(), __temp);
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0;
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "facet-list" }, _attrs))} data-v-ec2b8b03><h1 data-v-ec2b8b03>${ssrInterpolate(_ctx.title)}</h1><ul data-v-ec2b8b03><!--[-->`);
      ssrRenderList(unref(items), (val) => {
        _push(`<li data-v-ec2b8b03>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: `/screen/${encodeURIComponent(String(val))}`
        }, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/screen/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ec2b8b03"]]);

export { index as default };
//# sourceMappingURL=index-BSY1CZpw.mjs.map
